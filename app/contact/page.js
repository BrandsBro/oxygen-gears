    ...
    <div className={styles.page}>
      <div className={styles.inner}>
        ...
        <div className={styles.formSide}>
          ...
          {status === "success" && (
            <div className={styles.successMsg}>✅ Message sent! We'll be in touch soon.</div>
          )}
          {status === "error" && (
          ...
          <form onSubmit={handleSubmit} className={styles.form}>
            ...
            <div className={styles.field}>
              ...
              <input name="orderNumber" value={form.orderNumber} onChange={handleChange} placeholder="Your order number" />
            </div>
