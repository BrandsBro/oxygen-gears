...
export default function ShippingPolicy() {
  return (
    <PolicyPage title="Shipping Policy">
      ...
      <p>Orders are typically processed within 24–48 hours and delivered within 8–11 business days, depending on your location. You'll receive tracking as soon as your order ships. Delivery windows are estimates and can occasionally be affected by customs or carrier delays.</p>
      ...
      <p>Orders are insured during transit until delivery is completed. If a package can't be delivered, the courier will typically hold it at a local facility and reattempt. If you instruct the courier to leave the package unattended, we can't be responsible for loss or theft after it's marked delivered.</p>
