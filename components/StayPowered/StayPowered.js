...
export default function StayPowered({ config }) {
  const heading = config?.heading || "Charged and Ready, Wherever You Are";
  const subtext = config?.subtext || "Three power options mean you are always covered. Charge at home, plug into the car, or head out on the battery, and move through your day without a single worry about running low.";
